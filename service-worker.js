...
const STATIC_ASSETS = [
  ...
  '/price-service.min.js',
  '/tcg-prices.min.js',
  '/brazilian-stores.min.js',
  '/recommended-decks.min.js',
  '/collection-tracker.min.js',
  '/variant-tracker.min.js',
  '/keyword-parser.min.js',
  '/i18n.min.js',
  '/rulebook-pt.min.js',
  '/faq-pt.min.js',
  '/deck-guides-pt.min.js',
  '/flavor-text.min.js',
  '/rules-quiz.min.js',
  '/release-timeline.min.js',
  '/dust-tracker.min.js',
  '/promo-tracker.min.js',
  '/set-progress.min.js',
  '/threshold-calculator.min.js',
  '/gamification.min.js',
  '/card-scanner.min.js',
  '/artist-gallery.min.js',
  '/chase-cards-prices.min.js',
  '/nocodb-service.min.js',
  '/news-service.min.js',
